...
export const UserStatusCardSchema = z
  .object({
...
export const CreateUserStatusCardSchema = z
  .object({
    userId: z
      .string()
      .openapi({ example: "123e4567-e89b-12d3-a456-426614174000" }),
    ...
    allergy: z
      ...
      .nullable()
      .default(null)
      .openapi({ example: "卵、そば" }),
    medicine: z
      .string()
      .nullable()
      .default(null)
      .openapi({ example: "血圧の薬" }),
    ...
    disability: z
      ...
      .nullable()
      .default(null)
      .openapi({ example: "軽度の歩行障害" }),
    notes: z
      .string()
      .nullable()
      .default(null)
      .openapi({ example: "長時間の立位は困難" }),
  })
  .openapi("CreateUserStatusCard");

export const UpdateUserStatusCardSchema = z
  .object({
...
export const UserStatusCardDiseaseSchema = z
  .object({
...
export const CreateUserStatusCardDiseaseSchema = z
  .object({
    userStatusCardId: z
      .string()
      .openapi({ example: "123e4567-e89b-12d3-a456-426614174002" }),
...
export const UpdateUserStatusCardDiseaseSchema = z
  .object({
    name: z.string().min(1).openapi({ example: "高血圧" }),
  })
